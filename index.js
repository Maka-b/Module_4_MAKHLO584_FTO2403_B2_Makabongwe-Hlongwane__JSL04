...
userPreference ? 'Sugar-free' : 'Regular'
...
const result = cansLeft < 5  ? "Time to restock":"We're stocked!"
console.log(result);
...
const condition = heartRate < 100 ? "Boost needed!" : "Energy levels are high!"
...
const tempState = currentTemp < 5 ? "Chilled to perfection!" : "Needs a cooler!"
...
let currentHour = 22; 
const choice = 7 < currentHour < 24 ?  "Unleash the beast!":"Better stick to water."
console.log(choice) 
